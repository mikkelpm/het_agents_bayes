function sim_struct = simulate_micro_moments(sim_struct, simul_data_micro, T, ts_micro)
    ...
    sim_struct.smpl_m1 = mean(the_simul(:,:,1),2);
    sim_struct.smpl_m2 = mean(the_simul(:,:,2),2);
    sim_struct.smpl_m3 = var(the_simul(:,:,1),1,2);
    sim_struct.smpl_m4 = mean((the_simul(:,:,1)-sim_struct.smpl_m1).*(the_simul(:,:,2)-sim_struct.smpl_m2),2);
    sim_struct.smpl_m5 = var(the_simul(:,:,2),1,2);

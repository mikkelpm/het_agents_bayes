function [ys,params,check] = firstOrderDynamics_polynomials_distirf_steadystate(ys,exo,M_,options_)
...
% if ~isfield(M_, 'steady_vars') % Modified wrt firstOrderDynamics_polynomials_steadystate.m
    setParameters;
